...
const styles: Record<ToastType, string> = {
  ...
  info: "bg-ramadan-gold/15 border-ramadan-gold/40 text-ramadan-gold",
};
    ...
    <ToastContext.Provider value={{ toast }}>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[9999] flex flex-col gap-3 items-center pointer-events-none">
        {toasts.map((t) => (
          <div
            key={t.id}
            className={`pointer-events-auto flex items-center gap-3 px-5 py-3.5 rounded-xl border backdrop-blur-xl shadow-2xl animate-slide-up min-w-[280px] max-w-[90vw] ${styles[t.type]}`}
